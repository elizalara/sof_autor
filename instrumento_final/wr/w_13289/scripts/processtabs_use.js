...
processtabsUse1 = {
	...
	doUpdate: function() 
	{
		...
		if (tabCount == 2) {
			tabWidthPercentage = 556 / tabCount;
		} else if (tabCount == 3) {
		...
		jQuery.each(textArray, function(index, value) {
			...
			button_elem.innerHTML += "<li><a tabindex='" + tabindex + "' style='width: " + tabWidthPercentage + "px' id='" + index + "' class='title'>" + textArray[index] + "</a></li>";			
			//add content first 
